...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RelativeLayout lay = (RelativeLayout) findViewById(R.id.mylay);
        ...
        fin2 = (TextView) findViewById(R.id.fin2);
        
        sub = (Button) findViewById(R.id.p_sub);
        sub.setAlpha(0);
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	if(fin.getText().toString().compareTo(fin2.getText().toString())==0)
            	{
            		...
            		try
            		{
            			...
            			u.setEmail(Email);
            			u.setMob(Mob);
            			u.setPass(fin.getText().toString());
            			db.addUser(u);
            		...
            		{
            			Toast.makeText(MainActivity.this, ep.getMessage(), Toast.LENGTH_LONG).show();
            		}
            	}
            	else
            	{
                	...
                	Toast.makeText(MainActivity.this, "Password not Matched, please Re-Draw Your Pattern", Toast.LENGTH_LONG).show();
            	}
            }
        });
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (action & MotionEvent.ACTION_MASK) {
                    ...
                    case MotionEvent.ACTION_UP: 
                    {
                    	...
                    	if(fi.length >= 4)
                    	{
                    	if(fin2.getText().toString().compareTo("")==0)
                    	{
                    		fin2.setText(fin.getText().toString());
                        	...
                        	no.setText("");
                        	fin.setText("");
                        	Toast.makeText(MainActivity.this, "Please Re-Draw the Pattern", Toast.LENGTH_SHORT).show();
                    	}
                    	else 
                    	{
                    		a.setImageResource(R.drawable.black);
